...
qreg q[5];
creg c[3];
rx(5.37407945295297) q[0];
p(2.708093816117036) q[1];
ry(5.998944414326408) q[1];
u1(5.593207837210351) q[2];
ryy(4.447898740736538) q[0],q[2];
xx_plus_yy(3.3260223500813733,2.387729764945257) q[4],q[3];
xx_minus_yy(5.023214214402617,2.5462064596653144) q[4],q[3];
measure q[0] -> c[0];
measure q[1] -> c[1];
measure q[2] -> c[2];
