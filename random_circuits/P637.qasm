...
qreg q[5];
creg c[3];
p(1.9187106164491863) q[1];
ryy(0.3346233731299251) q[2],q[0];
cu(0.9510419267697238,1.5486231788081157,0.9820384929278801,1.5156498522963868) q[3],q[4];
cswap q[2],q[3],q[0];
ryy_139921335567888(3.843069826681737) q[4],q[1];
measure q[0] -> c[0];
measure q[1] -> c[1];
measure q[2] -> c[2];
