...
qreg q[5];
creg c[3];
u2(5.746636191401136,5.151708808453844) q[0];
cu(1.2096776291056768,6.099290105972669,5.085418352958782,0.6421679079799965) q[1],q[2];
x q[1];
sdg q[3];
cswap q[2],q[0],q[3];
x q[0];
ryy(3.1055427800727866) q[3],q[2];
swap q[3],q[0];
ry(5.743098805665278) q[0];
t q[3];
x q[4];
r(2.998731526709587,1.3657716295284443) q[4];
csx q[4],q[1];
t q[1];
cz q[2],q[4];
s q[2];
ryy_139921316983328(3.55233330466446) q[4],q[1];
measure q[0] -> c[0];
measure q[1] -> c[1];
measure q[2] -> c[2];
