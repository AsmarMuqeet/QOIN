...
qreg q[7];
creg c[3];
rxx(0.33497998993805284) q[2],q[3];
sdg q[2];
u1(1.5451146789653591) q[4];
z q[5];
xx_plus_yy(3.1627960655961984,0.1940225542116833) q[3],q[5];
ccx q[0],q[6],q[1];
u3(3.505148282565844,5.286298889951539,0.3727007006813735) q[1];
rxx(3.0494405970590774) q[4],q[0];
z q[6];
measure q[0] -> c[0];
measure q[1] -> c[1];
measure q[2] -> c[2];
