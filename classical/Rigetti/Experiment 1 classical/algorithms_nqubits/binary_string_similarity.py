...
class binary_string_similarity(abstract_interface):
    ...
    def get_result(self, backend, input_data, number_of_runs=1024, seed=1997):
        ...
        data = {"probability": [], "output": result['hamming_distances']}
    ...
    def get_happy_scene(self):
        return {"input": ['10010' ,'10001'], "output": [1], "probability": [
            {'bin': '100011', 'dec': 35, 'ascii': '#', 'count': 356, 'odds': 0.5329341317365269, 'prob': 0.34765625}, {'bin': '100010', 'dec': 34, 'ascii': '"', 'count': 668, 'odds': 1.8764044943820224, 'prob': 0.65234375}]}