...
tdg q[1];
swap q[0],q[3];
r(1.5653894965594626,0.7156043163971644) q[0];
id q[4];
tdg q[4];
rzx(0.6991156157919014) q[2],q[5];
cswap q[5],q[2],q[1];
h q[6];
cu(1.4793805847015424,4.585421228283478,6.177647648152031,2.986174003371638) q[3],q[6];
measure q[0] -> c[0];
measure q[1] -> c[1];
measure q[2] -> c[2];
