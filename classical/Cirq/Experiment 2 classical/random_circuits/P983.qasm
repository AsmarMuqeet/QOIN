...
cswap q[2],q[0],q[1];
z q[0];
cu(4.8301684084612715,1.679650481010952,4.384177979419593,4.120916037946989) q[1],q[2];
rzz(4.621016678131002) q[3],q[4];
xx_plus_yy(5.575304144912151,0.6314128986596151) q[3],q[4];
measure q[0] -> c[0];
measure q[1] -> c[1];
measure q[2] -> c[2];
