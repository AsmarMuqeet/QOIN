...
creg c[3];
x q[0];
u(5.449358152011265,2.993675001402876,5.066292227813704) q[0];
sdg q[1];
sdg q[2];
rzx(2.7831627723058294) q[2],q[1];
ryy(2.370076557160001) q[4],q[3];
r(4.55569083716902,1.3531297217918183) q[3];
tdg q[4];
measure q[0] -> c[0];
measure q[1] -> c[1];
measure q[2] -> c[2];
