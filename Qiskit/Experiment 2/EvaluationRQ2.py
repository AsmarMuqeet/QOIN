...
with open("results/RQ2A.json","w") as file:
    json.dump(RQ2A,file)
...
for bk,_ in tqdm(backends):    
    ...
    for cut in CUTs:
        ...
        mutant1_data = mutant1.get_result(backend,inps)
        mutant2_data = mutant2.get_result(backend,inps)
        mutant3_data = mutant3.get_result(backend,inps)
        for inp in inps:
            ...
            ps = PS_data[inp]
            ps = convertNaQp2QuCAT_notation(ps,value='prob')
            ps_count = convertNaQp2QuCAT_notation(PS_data[inp],value='count')
            ...
            # mutant 1:
            mutant_output = mutant1_data[inp]
            mutant_output = convertNaQp2QuCAT_notation(mutant_output,value='count')
            result = Uof(mutant_output,ps)
            #print("Uof mutant1,ps = ",result)
            if result=="P":
            ...
            # mutant 2:
            mutant_output = mutant2_data[inp]
            mutant_output = convertNaQp2QuCAT_notation(mutant_output,value='count')
            result = Uof(mutant_output,ps)
            #print("Uof mutant1,ps = ",result)
            if result=="P":
            ...
            # mutant 1:
            mutant_output = mutant3_data[inp]
            mutant_output = convertNaQp2QuCAT_notation(mutant_output,value='count')
            result = Uof(mutant_output,ps)
            #print("Uof mutant1,ps = ",result)
            if result=="P":
...
with open("results/RQ2B.json","w") as file:
    json.dump(RQ2B,file)
